...
CREATE TABLE SpotifyClone.users_follow_artists(
...
CREATE TABLE SpotifyClone.users_play_history(
  usuario_id INT NOT NULL,
  cancao_id INT NOT NULL,
  data_play DATETIME NOT NULL,
...
INSERT INTO SpotifyClone.users(usuario_id, plano_id, usuario, idade, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.users_follow_artists(usuario_id, artista_id)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
...
INSERT INTO SpotifyClone.albuns(album_id, artista_id, album, ano_lancamento)
VALUES
  (1, 1, 'Envious', 1990),
  (2, 1, 'Exuberant', 1993),
...
INSERT INTO SpotifyClone.cancoes(cancao_id, album_id, cancao, duracao)
VALUES
  (1, 1, 'Soul For Us', 200),
...
INSERT INTO SpotifyClone.users_play_history(usuario_id, cancao_id, data_play)
VALUES
